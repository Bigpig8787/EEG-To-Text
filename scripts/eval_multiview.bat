...
set CKPT=./checkpoints/multiview/best/task1_task2_taskNRv2_multiview_2step_b4_20_30_5e-05_5e-06_unique_sent_merged.pt
set CONF=./config/decoding/task1_task2_taskNRv2_multiview_2step_b4_20_30_5e-05_5e-06_unique_sent.json
