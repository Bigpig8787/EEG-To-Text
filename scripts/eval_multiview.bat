...
set CKPT=./checkpoints/multiview/best/task1_task2_taskNRv2_multiview_2step_b4_50_70_5e-05_5e-07_unique_sent_merged.pt
set CONF=./config/decoding/task1_task2_taskNRv2_multiview_2step_b4_50_70_5e-05_5e-07_unique_sent.json
