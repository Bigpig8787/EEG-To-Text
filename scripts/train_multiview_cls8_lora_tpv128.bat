@echo off
REM Multi-View Conformer — CLS=8 per view, tokens_per_view=128, pool_stride=25, LoRA r=16.
REM   - tokens_per_view=128 / pool_stride=25 hardcoded in train_multiview.py + eval_multiview.py
REM       (AvgPool 5000 -> 200, AdaptiveAvgPool 200 -> 128)
...
REM   - NO --no_lora flag here (ignored anyway; NO_LORA hardcoded False)
...
REM   - Output: ./checkpoints/multiview_cls8_lora_tpv128/best/<save_name>_merged.pt
python train_multiview.py ^
    ...
    --no_early_stop ^
    --lora_r 16 ^
    -s ./checkpoints/multiview_cls8_lora_tpv128 ^
    -cuda cuda:0
