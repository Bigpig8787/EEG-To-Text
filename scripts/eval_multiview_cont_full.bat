@echo off
REM Evaluate Multi-View Conformer — resumed full BART fine-tune merged checkpoint (cont_full)
set CKPT=./checkpoints/multiview/best/task1_task2_task3_taskNRv2_taskTSRv2_multiview_2step_b4_0_70_5e-05_5e-07_unique_sent_cont_full_merged.pt
set CONF=./config/decoding/task1_task2_task3_taskNRv2_taskTSRv2_multiview_2step_b4_0_70_5e-05_5e-07_unique_sent_cont_full.json
